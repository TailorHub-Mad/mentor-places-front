...
const ReviewCard: FC<IReviewCardProps> = ({ review, rating, date, enrolledTo }) => {
  ...
  return (
    <div className="review-card flex flex-col w-full md:w-[438px] md:min-h-[400px] bg-BLUE/40 p-[20px] rounded-[8px]">
      <LogoFavicon className="mb-10" width={50} height={50} strokeBg={'black'} />
